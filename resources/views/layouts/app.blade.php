...
<body>
 ...
 <footer>
          <div class="pull-right ">
            Gentelella Bala - Bootstrap Admin Template by <a href="https://colorlib.com">Colorlib</a>
          </div>
    ...
    <!-- gauge.js -->
    <script type="text/javascript" src="{{asset('endors/gauge.js/dist/gauge.min.js')}}"></script>
    <!-- bootstrap-progressbar -->
